...
/**
 * {@link ContentProvider} for New Leaf BookStore Inventory App.
 */
public class NewLeafProvider extends ContentProvider {

    /** Tag for the log messages */
    public static final String LOG_TAG = NewLeafProvider.class.getSimpleName();
    ...
    static {
        ...
        // of the books table.
        sUriMatcher.addURI(NewLeafContract.CONTENT_AUTHORITY, NewLeafContract.PATH_NEWLEAF, BOOKS);
        ...
        sUriMatcher.addURI(NewLeafContract.CONTENT_AUTHORITY, NewLeafContract.PATH_NEWLEAF + "/#", BOOK_ID);
    }

    /** Database helper object */
    private NewLeafDbHelper mDbHelper;

    @Override
    public boolean onCreate() {
        mDbHelper = new NewLeafDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case BOOKS:
                ...
                cursor = database.query(NewLeafContract.NewLeafEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case BOOK_ID:
                ...
                selection = NewLeafContract.NewLeafEntry._ID + "=?";
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        String productname = values.getAsString(NewLeafContract.NewLeafEntry.COLUMN_PRODUCT_NAME);
        if (productname == null) {
            throw new IllegalArgumentException("Requires a book name");
        }
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(NewLeafContract.NewLeafEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case BOOKS:
                ...
                rowsDeleted = database.delete(NewLeafContract.NewLeafEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case BOOK_ID:
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case BOOKS:
                return NewLeafContract.NewLeafEntry.CONTENT_LIST_TYPE;
            case BOOK_ID:
                return NewLeafContract.NewLeafEntry.CONTENT_ITEM_TYPE;
            default:
